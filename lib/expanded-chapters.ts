...
export const expandedChapters: Chapter[] = [
  {
    ...
    blocks: [
      ...
      callout(
        "내 방 점검",
        "다음 이사에도 가져가고 싶은 물건 세 개를 적어 보라. 비싸거나 희귀해서가 아니라 실제로 자주 쓰거나 볼 때 편안한 이유를 적는다.",
      ),
      subheading("임대 집에서는 무엇부터 확인할까"),
      ...paragraphs(
  ...
  },
  {
    ...
    blocks: [
      ...
      subheading("저장한 방이 모두 실제 목표는 아니다"),
      ...paragraphs(
      ...
      subheading("저장 이미지를 실제 구매 자료로 줄이기"),
      ...paragraphs(
      ...
      list(
        ...
        "물건 자체보다 좋아한 색과 배치는 무엇인가",
        "내 방에서 바꿀 수 없는 조건은 무엇인가",
        "오늘 하나를 고른다면 무엇을 포기해야 하는가",
      ),
      subheading("결정 부담을 줄이는 법"),
      ...paragraphs(
  ...
  },
  {
    ...
    blocks: [
      ...
      subheading("내가 좋아하는 것과 사진이 잘 나오는 것"),
      ...paragraphs(
      ...
      callout(
        "두 장의 사진",
        "방을 가장 정돈했을 때 한 장, 평소 생활 모습으로 한 장을 찍어 보라. 어느 사진이 실제로 자주 쓰는 물건과 동선을 더 잘 보여 주는지 살핀다.",
      ),
      subheading("촬영이 끝난 뒤에도 좋은 작품"),
      ...paragraphs(
